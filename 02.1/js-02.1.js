...
document.write("<p>Exibindo um elemento do array através do indice:</p>");
document.write(`<p>${products[3]}</p>`);
 
document.write("<p>Percorrendo um array através do forEarch</p>");
products.forEach((produto) => {
  document.write(`<p>${produto}</p>`);
});
 
document.write("<p>Mostrando os indices de valores com forEach</p>");
